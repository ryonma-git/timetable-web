...
def src_url(tid, subj, g):
    ...
    if tid.startswith("kobun_doutoku"): return f"https://www.kobun.co.jp/textbook2024/doutoku/pdf/nenkanshidoukeikaku_{gi}nen_hyoka_202502.xlsx"
    if tid.startswith("gakken_doutoku"): return "https://gakkokyoiku.gakken.co.jp/r6text_doutoku/img/2024_syoudou_nenkei_202404.zip"
    if tid.startswith("nichibun_doutoku"): return f"https://www.nichibun-g.co.jp/textbooks/s-doutoku/download/r6/r6_doutoku_nenkei_{gi}.xlsx"
    if tid.startswith("nichibun_sansu"): return f"https://www.nichibun-g.co.jp/textbooks/sansu/download/r6/r6_sansu_nenkei_{gi}.xlsx"
    if tid.startswith("nichibun_zuko"): return "https://www.nichibun-g.co.jp/textbooks/zuko/download/r6/r6_zuko_nenkei_hyouka.xlsx"
