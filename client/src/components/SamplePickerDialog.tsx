...
import { BookOpen, Dumbbell, Music, Loader2 } from "lucide-react";
...
const SAMPLES: SampleDef[] = [
  ...
  },
  {
    id: "single",
    title: "体育専科 第3学期 時間割",
    description: "単一教科モードのデモデータです。実際の体育専科の時間割データを使用しています。",
    mode: "single_subject",
    modeLabel: "単一教科モード",
    ...
    details: [
      "担当クラス: 4〜6年生 計10クラス（4年3・5年4・6年3）",
      "教科: 体育",
      "期間: 2026年1月8日〜3月24日（第3学期）",
      "授業変更操作: 28件（振替・入れ替え・休講など）",
    ],
  },
  {
    id: "multi",
    title: "音楽・図工専科 第3学期 時間割",
    description: "複数教科モードのデモデータです。音楽と図工の2教科を担当する専科教員の例です。",
    mode: "multi_subject",
    modeLabel: "複数教科モード",
